...
(function(global){
    ...
    var Class = (function(){
        ...
        function create(){
            ...
            function overrideMethod(childMethod, parentMethod){
                var method = function(){
                    var childScope = this;
                    var $super = (parentMethod !== undefined) ? function(){
                        return parentMethod.apply(childScope, arguments);
                    } : undefined;
    ...
    /** @lends arc.EventDispatcher.prototype */
    {
        ...
        addEventListener:function(type, callback){
            ...
            EventDispatcher.listenHash[type].push({
                target : this, 
                callback : callback
            });
        },
    ...
    /** @lends arc.System.prototype */
    {
        ...
        _setEvent:function(){
            ...
            function getPos(obj){
                return {
                    x:obj.pageX / self._canvasScale - self._canvas.offsetLeft, 
                    y:obj.pageY / self._canvasScale - self._canvas.offsetTop
                };
            }
            ...
            function touchStart(e){
                ...
                function doEvent(obj, id){
                    ...
                    var event = new Event(Event.TOUCH_START, {
                        x:pos.x, 
                        y:pos.y
                    });
            ...
            function touchMove(e){
                ...
                function doEvent(obj, id){
                    ...
                    if(target){
                        var event = new Event(Event.TOUCH_MOVE, {
                            x:pos.x, 
                            y:pos.y
                        });
                        dispatchTarget(target, event);	
            ...
            function touchEnd(e){
                ...
                function doEvent(obj, id){
                    ...
                    if(target){
                        var event = new Event(Event.TOUCH_END, {
                            x:pos.x, 
                            y:pos.y
                        });
                        dispatchTarget(target, event);
        ...
        _loading:function(){
            this.dispatchEvent(Event.PROGRESS, {
                total:this._imageManager.getTotal(), 
